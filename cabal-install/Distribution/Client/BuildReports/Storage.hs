...
storeLocal cinfo templates reports platform = sequence_
  ...
  where
    ...
    reportFileName template report = fromPathTemplate
...
fromPlanPackage (Platform arch os) comp (InstallPlan.Configured (ConfiguredPackage _ srcPkg flags _ deps)) (Just buildResult)
  = Just
    (BuildReport.new os
                     arch
                     comp
                     ...
                     buildResult, extractRepo srcPkg)
  where
